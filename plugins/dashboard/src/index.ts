...
const DashboardPlugin = plugin(
  'Dashboard' as Plugin<DashboardService>,
  { core: core.id, presentation: presentation.id },
  {
    ...
    icon: {
      Dashboard: '' as Asset,
      DashboardView: '' as Asset
    },
    mixin: {
      DashboardInfo: '' as Ref<Mixin<ComponentExtension<VDoc>>>
    },
    component: {
...
export function getChunterService (): Promise<DashboardService> {
  return getPlatform().getPlugin(DashboardPlugin.id)
}

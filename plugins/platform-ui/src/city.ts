...
import {
  Scene, WebGLRenderer, PCFSoftShadowMap, Fog, BoxGeometry,
  MeshBasicMaterial, Color, Mesh, PointLight, DirectionalLight,
  MeshPhongMaterial, PlaneGeometry, Object3D, Camera
} from 'three'

import * as THREE from 'three'
import { TweenMax } from 'gsap'

export function createCity (camera: Camera) {
  ...
  var smoke = new Object3D()
  var town = new Object3D()

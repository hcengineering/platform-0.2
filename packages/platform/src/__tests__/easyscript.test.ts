...
import { THIS, DUP, GET, APPLY0, APPLY1, ARG0, CONCAT, execute } from '../easyscript'
...
describe('easyscript', () => {
  ...
  it('should concat strings', () => {
    const code = `${THIS},firstName,${GET},${THIS},lastName,${GET},${CONCAT}`
    console.log(code)
    ...
    const result = execute(code, _this, [])
    console.log(result)
    expect(result).toBe('Appleseed John') // like Russians expected
  })
})
